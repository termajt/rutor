...
use crate::{
    ...
    bitfield::Bitfield,
    disk2::{DiskError, DiskJob, DiskManager2},
    net::{NetEvent, NetManager},
    picker2::{PiecePicker2, PieceReceiveStatus},
    torrent::Torrent,
};
...
impl Engine2 {
    pub fn new(
        ...
        let disk_mgr = DiskManager2::new(&torrent)?;
        ...
        let piece_picker = PiecePicker2::new(total_pieces, total_size, piece_length);
